...
public class StageController : MonoBehaviour, IBootStrapper
{
    ...
    {
        context.TryGet(out monsterFactory);
        context.TryGet(out itemDropManager);
    }
    ...
    public void IBootStrapperInitialize()
    {
        ...
        else if (monsterFactory == null)
        {
            Debug.LogWarning("[StageController] MonsterFactory가 없습니다. 몬스터 스폰이 비활성화됩니다.", this);
            spawner = null;
        }
        else
        {
