...
//ù?ùùù ùù?ùù?ùùù?ù ùùùù pathfinderùù „ù¥ù.
//ù? FSMùùùù ?ùùùù Traceù?ù ù?ù ùùùùùù?ù ùù.
...
{   
    ...
    private void Awake()//ùù?ùù?ùùù?ùùù ùùùùùù ù?ù.
    {
        ...
        groundContactFilter.SetLayerMask(GroundLayerMask); //ùùùù ùùùùùù ùùùù?ùùù ù?ù ùùù?ù ùùùù? ùùùù
        groundContactFilter.useTriggers = false; //ùùùù ùùùùùù Triggerùùùù ù?ùù?ù ùùùù
    }
    ...
    public void Trace(Vector2 targetPos, float moveSpeed) //FSMùùùù ùùùùùù ?ùùù?ù ùù ù?ù.
                                         //ù˜ùù?? ù?ùùùùù ùù repathù?ùùù ùùùù?
    {       
    ...
    private void Walk(Navi2DNode targetNode) //ùùù?ù ùùùù ù??ù ù?ù ùù? ùùùùù?ù ù?ùùù ùùùù ù?ù ùùùù?.
    {
    ...
    private void StartAirMove(Navi2DPathStep step)
    {
        ...
        if (!canAirMove)
        {
            Debug.LogWarning($"AirMove ù?ùùù :{step.fromNode.gridPos} -> {step.toNode.gridPos}");
